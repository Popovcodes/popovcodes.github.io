    ...
    $('.figure').each(function(){
      ...
      if(thisVisible > 0) {
        if(isSafari == 1) {
          ...
          $('.equip-section .divided-text-block').css('margin-bottom', '50px');
          $('.equip-list li, .features-list li, #red-line, #blue-line, .figure img, .abonement-img').css('transition', 'none !important');
        } else {
