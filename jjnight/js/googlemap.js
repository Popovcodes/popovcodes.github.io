...
function init() {
    ...
    var marker = new google.maps.Marker({
        position: new google.maps.LatLng(55.792502, 37.676794),
        map: map,
        title: 'Just Jump!',
        icon: {
            url: "/img/pin.png",
